      ...
      <form>
        <div class="formNotice">
          <ul>
            ...
            <li>
              勝ち抜け順の判定は「最終スコア」→「正答数の多さ」→「誤答数の多さ」→「席順」で行われます
            </li>
          </ul>
        </div>
        <h2>形式設定</h2>
        ...
        <div class="row">
          ...
          <div class="form-group col-sm-4">
            <label>初期値 <span class="badge badge-danger">必須</span></label>
            <input
              class="form-control"
      ...
      for (let i = 0; i < value; i++) {
        if (this.data.players[i]) {
          ...
          list.push({
            ...
            score: { score: 15, correct: 0, wrong: 0, evaluation: 0 },
          });
        }
      }
