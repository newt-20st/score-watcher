      ...
      >
        ...
        <div class="playerScore">
          ...
          <div class="productScore">
            {{ player.score.score.odd }} ✕ {{ player.score.score.even }}
          </div>
          <div class="eachScore">
...
export default {
  ...
  methods: {
    ...
    calcOrder(index) {
      const score =
        this.data.players[index].score.score.odd *
        this.data.players[index].score.score.even;
